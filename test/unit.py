...
class TestFindFeaturesShortestDistance(unittest.TestCase):
    ...
    """
        ...
        test_feature01 = ['test_feature01', '4', '5'] # (2, 4) distance: 5 
        test_feature02 = ['test_feature02', '6', '13'] # (5, 12) distance: 13
        test_feature03 = ['test_feature03', '9', '16'] # (8, 15) distance: 17
        test_feature_list =\
        [test_feature00, test_feature01, test_feature02, test_feature03]
        start_index = 0
        
        output = find_features_shortest_distance(start_index, test_feature_list)
        self.assertEqual(['test_feature00', 'test_feature03', 17], output, 'Features longest distance incorrect')
